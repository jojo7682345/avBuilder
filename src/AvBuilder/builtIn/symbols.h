...
#define BUILT_IN_FUNCS \
    ...
    BUILT_IN_FUNC(fileLastModified, {VALUE_TYPE_STRING})\
    ...
    BUILT_IN_FUNC(compileString, { VALUE_TYPE_STRING|VALUE_TYPE_ARRAY })\
    BUILT_IN_FUNC(toUppercase, { VALUE_TYPE_STRING|VALUE_TYPE_ARRAY })\
    BUILT_IN_FUNC(toLowercase, { VALUE_TYPE_STRING|VALUE_TYPE_ARRAY })\
    BUILT_IN_FUNC(changeDir, { VALUE_TYPE_STRING|VALUE_TYPE_ARRAY })\
    BUILT_IN_FUNC(currentDir, {})\
    BUILT_IN_FUNC(callExtern, {VALUE_TYPE_STRING, VALUE_TYPE_STRING })\
	BUILT_IN_FUNC(call, {VALUE_TYPE_STRING})\
    BUILT_IN_FUNC(parseDependencies, {VALUE_TYPE_STRING, VALUE_TYPE_STRING | VALUE_TYPE_ARRAY })
